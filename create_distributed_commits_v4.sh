...
echo "🔄 Criando commits distribuídos ao longo dos dias..."

# Reset para criar commits menores
git reset --soft HEAD~1

# Commit 1: Limpeza de arquivos antigos (15/10 - manhã)
echo "📅 Commit 1: 15/10/2025 - 09:30 - Limpeza de arquivos antigos"
...
echo "📅 Commit 2: 15/10/2025 - 16:45 - Atualização da documentação"
...
echo "📅 Commit 3: 16/10/2025 - 10:15 - Implementação do DataTable no core"
...
echo "📅 Commit 4: 16/10/2025 - 15:30 - Novos componentes UI"
...
echo "📅 Commit 5: 17/10/2025 - 11:00 - Implementação completa do DataTable no forms"
...
echo "📅 Commit 6: 17/10/2025 - 17:20 - Novo showcase example e documentação"
...
echo "📅 Commit 7: 18/10/2025 - 09:45 - Atualizações finais e ajustes de dependências"
...
echo "1. refactor: remove outdated examples and AI agent documentation"
echo "2. docs: update main documentation and getting started guide"
echo "3. feat(core): implement DataTable router and filter utilities"
echo "4. feat(ui): add new components (DatePicker, DropdownMenu, Popover)"
echo "5. feat(forms): implement complete DataTable functionality"
echo "6. feat: add comprehensive showcase example and documentation"
echo "7. chore: update dependencies and lock file"
